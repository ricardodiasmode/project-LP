...
\\000"
 ...
 (1, 
"\003\003\003\003\003\003\003\003\003\017\019\003\003\003\003\003\
\\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\
\\017\016\003\003\003\003\014\003\003\003\013\012\003\011\003\010\
...
{fin = [], trans = 1},
{fin = [(N 29)], trans = 0},
{fin = [(N 10),(N 29)], trans = 4},
{fin = [(N 10)], trans = 4},
{fin = [(N 17),(N 29)], trans = 0},
{fin = [(N 27),(N 29)], trans = 0},
{fin = [(N 7),(N 29)], trans = 8},
{fin = [(N 7)], trans = 8},
{fin = [(N 25),(N 29)], trans = 0},
{fin = [(N 21),(N 29)], trans = 0},
{fin = [(N 19),(N 29)], trans = 0},
{fin = [(N 23),(N 29)], trans = 0},
{fin = [(N 29)], trans = 14},
{fin = [(N 15)], trans = 0},
{fin = [(N 12),(N 29)], trans = 0},
{fin = [(N 4),(N 29)], trans = 17},
{fin = [(N 4)], trans = 17},
{fin = [(N 1)], trans = 0}])
end
...
| 29 => let val yytext=yymktext() in error("\n*** Lexer error: character invalid ***\n");
