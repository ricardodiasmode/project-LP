...
\\000"
 ...
 (1, 
"\003\003\003\003\003\003\003\003\003\019\021\003\003\003\003\003\
\\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\
\\019\018\003\003\003\003\016\003\015\014\013\012\003\011\003\010\
...
{fin = [], trans = 1},
{fin = [(N 33)], trans = 0},
{fin = [(N 10),(N 33)], trans = 4},
{fin = [(N 10)], trans = 4},
{fin = [(N 17),(N 33)], trans = 0},
{fin = [(N 27),(N 33)], trans = 0},
{fin = [(N 7),(N 33)], trans = 8},
{fin = [(N 7)], trans = 8},
{fin = [(N 25),(N 33)], trans = 0},
{fin = [(N 21),(N 33)], trans = 0},
{fin = [(N 19),(N 33)], trans = 0},
{fin = [(N 23),(N 33)], trans = 0},
{fin = [(N 31),(N 33)], trans = 0},
{fin = [(N 29),(N 33)], trans = 0},
{fin = [(N 33)], trans = 16},
{fin = [(N 15)], trans = 0},
{fin = [(N 12),(N 33)], trans = 0},
{fin = [(N 4),(N 33)], trans = 19},
{fin = [(N 4)], trans = 19},
{fin = [(N 1)], trans = 0}])
end
...
| 33 => let val yytext=yymktext() in error("\n*** Lexer error: character invalid ***\n");
