...
\\022\021\003\003\003\003\019\003\018\017\016\015\014\013\003\012\
...
{fin = [(N 10)], trans = 4},
{fin = [(N 37),(N 39)], trans = 0},
{fin = [(N 35),(N 39)], trans = 0},
{fin = [(N 17),(N 39)], trans = 0},
{fin = [(N 27),(N 39)], trans = 0},
{fin = [(N 7),(N 39)], trans = 10},
{fin = [(N 7)], trans = 10},
{fin = [(N 25),(N 39)], trans = 0},
{fin = [(N 21),(N 39)], trans = 0},
{fin = [(N 33),(N 39)], trans = 0},
{fin = [(N 19),(N 39)], trans = 0},
{fin = [(N 23),(N 39)], trans = 0},
{fin = [(N 31),(N 39)], trans = 0},
{fin = [(N 29),(N 39)], trans = 0},
{fin = [(N 39)], trans = 19},
{fin = [(N 15)], trans = 0},
...
| 39 => let val yytext=yymktext() in error("\n*** Lexer error: character invalid ***\n");
