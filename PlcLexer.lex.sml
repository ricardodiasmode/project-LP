...
\\000"
 ...
 (1, 
"\003\003\003\003\003\003\003\003\003\024\026\003\003\003\003\003\
\\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\
\\024\023\003\003\003\003\021\003\020\019\018\017\016\015\003\014\
\\012\012\012\012\012\012\012\012\012\012\010\009\003\008\003\003\
...
{fin = [], trans = 1},
{fin = [(N 42)], trans = 0},
{fin = [(N 10),(N 42)], trans = 4},
{fin = [(N 10)], trans = 4},
{fin = [(N 37),(N 42)], trans = 0},
{fin = [(N 35),(N 42)], trans = 0},
{fin = [(N 17),(N 42)], trans = 0},
{fin = [(N 27),(N 42)], trans = 0},
{fin = [(N 42)], trans = 10},
{fin = [(N 40)], trans = 0},
{fin = [(N 7),(N 42)], trans = 12},
{fin = [(N 7)], trans = 12},
{fin = [(N 25),(N 42)], trans = 0},
{fin = [(N 21),(N 42)], trans = 0},
{fin = [(N 33),(N 42)], trans = 0},
{fin = [(N 19),(N 42)], trans = 0},
{fin = [(N 23),(N 42)], trans = 0},
{fin = [(N 31),(N 42)], trans = 0},
{fin = [(N 29),(N 42)], trans = 0},
{fin = [(N 42)], trans = 21},
{fin = [(N 15)], trans = 0},
{fin = [(N 12),(N 42)], trans = 0},
{fin = [(N 4),(N 42)], trans = 24},
{fin = [(N 4)], trans = 24},
{fin = [(N 1)], trans = 0}])
end
...
let fun continue() = lex() in
 ...
 in (yybufpos := i; case yyk of 
  ...
  1 => (lineNumber := !lineNumber + 1; EOF(!pos, !pos))
...
| 23 => (MULTI(!pos, !pos))
| 25 => (DIV(!pos, !pos))
| 27 => (SEMICOLON(!pos, !pos))
| 29 => (OPENPARENT(!pos, !pos))
| 31 => (CLOSEPARENT(!pos, !pos))
| 33 => (COMMA(!pos, !pos))
| 35 => (OPENSQRBRACKET(!pos, !pos))
| 37 => (CLOSESQRBRACKET(!pos, !pos))
| 4 => (lex())
| 40 => (DOUBLEDOUBLEDOTS(!pos, !pos))
| 42 => let val yytext=yymktext() in error("\n*** Lexer error: character invalid ***\n");
      raise Fail("Lexer error: character invalid " ^ yytext) end
| 7 => let val yytext=yymktext() in Number(strToInt(yytext), !pos, !pos) end
